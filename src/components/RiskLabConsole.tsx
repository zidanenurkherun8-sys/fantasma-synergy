...
function RiskLabConsole({
  ...
  return (
    <div className="flex-1 flex flex-col lg:flex-row gap-6 lg:overflow-hidden h-auto lg:h-[calc(100vh-200px)] pb-16 lg:pb-0 w-full max-w-full min-w-0">
      ...
      <TiltCard className="w-full lg:flex-1 p-4 flex flex-col gap-5 h-auto lg:h-full lg:overflow-y-auto bg-[#07090F] max-w-full min-w-0">
      ...
      <TiltCard className="w-full lg:w-2/5 p-4 flex flex-col gap-4 h-auto lg:h-full lg:overflow-y-auto bg-[#07090F] max-w-full min-w-0">
