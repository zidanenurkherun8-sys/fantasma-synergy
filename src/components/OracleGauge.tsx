...
export default function OracleGauge({ signal, loading }: OracleGaugeProps) {
  ...
  if (!signal) {
    return (
      <div className="quantum-card rounded-[3px] p-6 border border-[#1E2333] bg-[#07090F] flex flex-col items-center justify-center text-center h-48 select-none text-slate-500 font-sans">
  ...
  return (
    <div className={`quantum-card rounded-[3px] p-5 border border-[#1E2333] bg-[#07090F] flex flex-col items-center justify-center text-center relative select-none ${glowClass}`}>
      ...
      >
        ...
        {showTooltip && models.length > 0 && (
          <div className="absolute top-28 z-50 w-52 bg-[#030407] border border-[#1E2333] p-3 rounded-[3px] shadow-2xl text-left pointer-events-none animate-fadeIn">
